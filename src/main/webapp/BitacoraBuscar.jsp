    ...
    <body>
        ...
        <div class="container">
            <div class="form-group">
                ...
                <label for="usr">Buscar BitacoraBusc por ID:</label>
                ...
                <div class="w3-container w3-card w3-white">
                    <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-user-circle w3-margin-right w3-xxlarge w3-text-teal"></i>BitacoraBusc Id </h2>
                    <div class="w3-container">
                        <h5 class="w3-opacity"><b>Nombre: objetoIDb.fechaNacimiento</b></h5>
                        <h5 class="w3-opacity"><b>Fecha: objetoIDb.fechaNacimiento</b></h5>
                        <h5 class="w3-opacity"><b>Hora: objetoIDb.fechaNacimiento</b></h5>

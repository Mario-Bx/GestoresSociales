    ...
    <body>
        ...
        <div class="container">
            <div class="form-group">
                ...
                <label for="usr">Buscar ResrvaBusc por ID:</label>
                ...
                <div class="w3-container w3-card w3-white">
                    <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-user-circle w3-margin-right w3-xxlarge w3-text-teal"></i>ResrvaBusc Id </h2>
